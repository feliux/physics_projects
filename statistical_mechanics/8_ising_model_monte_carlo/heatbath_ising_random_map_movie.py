...
for step in range(nsteps):
    ...
    if S1 == S2:
        ...
        plot_many_configurations([S1, S2], "snap-%06i.png" % step, L, {j : "g" for j in range(N)})
        break
    else:
    ...
    if step % nskip == 0:
        ...
        colors[k] = "b"
        plot_many_configurations([S1, S2], "snap-%06i.png" % step, L, colors)