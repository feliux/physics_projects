...
for N in list_N:
    ...
    pylab.hist(x, bins=100, density=True, alpha=0.5, range=[-10.0, 10.0], label="N=%i" % N)
...
pylab.xlabel("rescaled average $\epsilon$", fontsize=18)
pylab.ylabel("histogram $\pi(\epsilon)$", fontsize=18)
pylab.title("$\gamma=%f$" % gamma, fontsize=18)
pylab.savefig("images/histo-direct-gamma-average-rescaled.png")