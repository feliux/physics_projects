...
histo, bins, patches = pylab.hist(pair_corr, bins=800, density=True)
...
pylab.savefig("images/plot-pins_noreject_periodic-N%04i-L%.1f-pair_corr.png" % (N, L))
pylab.show()
pylab.clf()
...
pylab.savefig("images/plot-pins_noreject_periodic-N%04i-L%.1f-pair_corr_deviation.png" % (N, L))
pylab.show()